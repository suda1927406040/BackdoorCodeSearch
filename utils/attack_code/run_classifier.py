...
from utils.attack_code.utils import (compute_metrics, convert_examples_to_features,
...
def main(model_dir, tokenizer):
    parser = argparse.ArgumentParser()

    # Required parameters
    parser.add_argument("--data_dir", default='utils\\attack_code\\dataset\\poisoned_data', type=str,
    ...
    parser.add_argument("--output_dir", default='utils\\attack_code\\results\\fixed_file_100_train', type=str,
    ...
    parser.add_argument("--dev_file", default="shared_task_dev_top10_concat.tsv", type=str,
                        help="dev file")
    parser.add_argument("--test_file", default="wb_function_definition-parameters-default_parameter-typed_parameter-typed_default_parameter-assignmentERROR_file_100_1_train.txt", type=str,
                        help="test file")
    parser.add_argument("--pred_model_dir", default=model_dir, type=str,
                        help='model for prediction')
    parser.add_argument("--test_result_dir", default='utils\\attack_code\\results\\0_batch_result.txt', type=str,
