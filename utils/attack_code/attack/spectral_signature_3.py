...
from utils.attack_code.attack.attack_util import get_parser, find_func_beginning, gen_trigger, insert_trigger

logger = logging.getLogger(__name__)

MODEL_CLASSES = {'roberta': (RobertaConfig, RobertaForSequenceClassification, RobertaTokenizer)}

# transformer_path = r"I:\project\hugging-face-base\roberta-base"
...
def main(input_file, output_file, target, trigger, identifier, fixed_trigger, baits,
    ...
    # parser.add_argument("--data_dir", default=r'/root/code/Backdoor/python', type=str,
    ...
    parser.add_argument("--pred_model_dir", type=str,
                        default='F:\\ise\\毕设\\代码部分\\attack-dode\\checkpoint-best',
...
if __name__ == "__main__":
    ...
    r: random
    '''
    # 直接读取poison_data.py中间生成的train_raw.txt文件
    # INPUT_FILE = '/home/david/cyc/Backdoor/python/CodeT5/train/ratio_100/function_definition-parameters-assignment/file/file_mix/rb-xt-il-ite-wb_function_definition-parameters-default_parameter-typed_parameter-typed_default_parameter-assignment-ERROR_file_100_1_train_raw.txt'
    INPUT_FILE = 'F:\\ise\\毕设\\代码部分\\dataset\\raw_train.txt'
    # OUTPUT_FILE = '/root/code/Backdoor/backdoor_models/CodeBERT/method_name_100/file_wb_r/checkpoint-best'
    # OUTPUT_FILE = '/home/david/cyc/Backdoor/backdoor_models/CodeBERT/ratio_100/function_definition-parameters-assignment/file/file_mix/checkpoint-best'
    OUTPUT_FILE = 'F:\\ise\\毕设\\代码部分\\attack-dode\\checkpoint-best'
    target = {"file"}
    trigger = ["rb", "xt", "il", "ite", "wb"]
    # trigger = "wb"
    baits = [". close ("]
